...
public class AdminDashboardStatsDto {
    ...
    public long getApprovedAnonymousPosts() { return approvedAnonymousPosts; }

    public void setApprovedAnonymousPosts(long approvedAnonymousPosts) { this.approvedAnonymousPosts = approvedAnonymousPosts; }

    public long getRejectedAnonymousPosts() { return rejectedAnonymousPosts; }

    public void setRejectedAnonymousPosts(long rejectedAnonymousPosts) { this.rejectedAnonymousPosts = rejectedAnonymousPosts; }
