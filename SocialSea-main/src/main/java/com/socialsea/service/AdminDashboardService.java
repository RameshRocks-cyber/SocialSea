...
public class AdminDashboardService {
    ...
    public List<ChartPointDto> postGrowth() {
        return anonRepo.countApprovedGroupedByDate(LocalDateTime.of(2024, 1, 1, 0, 0));
    }
    ...
    public List<ChartPointDto> getPostGrowth(int days) {
        ...
        return anonRepo.countApprovedGroupedByDate(from);
    }
    ...
    public Map<String, List<ChartPointDto>> charts(int days) {
        ...
        return Map.of(
            ...
            "posts", anonRepo.countApprovedGroupedByDate(from)
        );
    }
    ...
    public String exportPostsCsv(int days) {
        ...
        return CsvUtil.toCsv(anonRepo.countApprovedGroupedByDate(from));
    }
}